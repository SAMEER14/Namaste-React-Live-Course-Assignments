...
// CREATED A restaurant card with creating own object
/*
...
const RestaurantCard = (props) => {
  ...
  <div className="res-card">
      <img src= {"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+
                    resDataList.data.cloudinaryImageId}
      className="res-logo" alt ="logoFood"/>
      <h2>{resDataList.data.name}</h2>
      <h4>{resDataList.data.cuisines.join(", ")}</h4>
      <h4>&#9733; {resDataList.data.avgRating} STARS</h4>
      <h4>{resDataList.data.deliveryTime} MINS</h4>
      <h4>&#8377; {resDataList.data.costForTwo/100} FOR TWO</h4>
  </div>
...
{/* -------------------------------------------------------- */}
        {/* we cant pass each and every data here  
        we can pass the data in object form in here*/}
        ...
        resData= {dominosObj}
        /> */}
        {/* resData is passed as props which comes from {dominosObj} object we pass */}
{/* ------------------------------------------------------------- */}
        <RestaurantCard 
        resDataList = {resObj[0]}
        />
        <RestaurantCard 
        resDataList = {resObj[0]}
        />
        <RestaurantCard resDataList = {resObj[1]}/>
        <RestaurantCard resDataList = {resObj[2]}/>
        <RestaurantCard resDataList = {resObj[3]}/>

        {/* THIS HERE WE USE REUSABLE COMPONENT making component once and showing dynamic data (was able to pass dynamic props*/}
 ...
 */
    ...
    /*in real world there will be list of OBJECT (restaurant)
    const resList = [
      { 
